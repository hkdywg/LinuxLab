...
#ifndef __DISPLAY_SERDES_CORE_H_
#define __DISPLAY_SERDES_CORE_H_
...
#define MFD_SERDES_DISPLAY_VERSION  "serdes-display-v100"
...
struct serdes_panel {
    ...
    enum drm_connecor_status status;
