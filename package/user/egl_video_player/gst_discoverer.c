...
int gst_discoverer_main ( const char *filename)
{
   int argc = 2;
  GError *err = NULL;
  GstDiscoverer *dc;
  ...
  ctx =g_option_context_new("- discover files synchronously with GstDiscoverer");
