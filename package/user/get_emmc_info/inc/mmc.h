...
#define MMC_GO_IDLE_STATE         0   /* bc                          */                 //CMD 0 Reset the mmc card to enter the idle state
#define MMC_GO_IDLE_STATE_ARG       0x0                                                 //CMD 0 Put the mmc card into the idle state
#define MMC_GO_PRE_IDLE_STATE_ARG   0xF0F0F0F0                                          //CMD 0 Reset the mmc card to enter the Pre-IDLE state
#define MMC_BOOT_INITIATION_ARG     0xFFFFFFFA                                          //CMD 0 Initialize into boot
#define MMC_SWITCH      6   /* ac   [31:0] See below    R1b */                          //CMD 6 Switch the operation mode of the selected device or modify the EXT_CSD register
#define MMC_SELECT_CARD     7   /* ac   [31:16] RCA        R1  */                       //CMD 7 add 2025/04/24 according to the kernel definition, where bits 16 to 31 are RCA, totaling 16 bits
#define MMC_SEND_EXT_CSD    8   /* adtc             R1  */                              //CMD 8 Let the device send the data of its own EXT_CSD register
#define MMC_STOP_TRANSMISSION  12      /* ac                           R1b */           //CMD 12 Force the device to stop transmission. If the HPI flag is set, the device will stop within the set time
#define MMC_SEND_STATUS     13  /* ac   [31:16] RCA        R1  */                       //CMD 13 SQS bit = 0: The addressing device sends the status register SQS bit = 1: This indicates that it is a QSR query
#define R1_SWITCH_ERROR   (1 << 7)  /* sx, c */
#define MMC_SWITCH_MODE_WRITE_BYTE  0x03    /* Set target to value */
#define MMC_READ_MULTIPLE_BLOCK  18   /* adtc [31:0] data addr   R1  */
#define MMC_SET_BLOCK_COUNT      23   /* adtc [31:0] data addr   R1  */                 //CMD 23 Define the number of read and write blocks and write one read/write instruction
